            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex items-center justify-between py-4">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <a href="/product" className="text-slate-700 hover:text-primary transition-colors">
                            Termék
                        </a>
                        <a href="/use-cases" className="text-slate-700 hover:text-primary transition-colors">
