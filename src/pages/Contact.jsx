...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitError(
        "Hiba történt azűrlap elküldése során. Kérjük, próbálja újra később."
      );
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center text-white max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl mb-8">
              Vegye fel velünk a kapcsolatot, hogy többet tudjon meg a SQUO
              projektről és a partnerségi lehetőségekről.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-slate-700 mb-8">
                Töltse ki az alábbi űrlapot, és csapatunk hamarosan felveszi
                Önnel a kapcsolatot.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Általános érdeklődés">
                      Általános érdeklődés
                    </option>
                    <option value="Partnerségi lehetőségek">
                ...
                {submitSuccess && (
                  <div className="p-4 bg-green-100 text-green-800 rounded-md">
                    Köszönjük! Üzenetét sikeresen elküldtük. Hamarosan
            ...
            <div>
              ...
              <p className="text-lg text-slate-700 mb-8">
                Az alábbi elérhetőségen is felveheti velünk a kapcsolatot.
              </p>
