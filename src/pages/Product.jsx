        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center text-white max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl mb-8">
              Ismerje meg a jövő palackmentes italautomatáját, amely
              forradalmasítja az italfogyasztást.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Termékünk</h2>
              <p className="text-lg text-slate-700 mb-6">
                A SQUO egy innovatív italautomata, amely lehetővé teszi a
                felhasználók számára, hogy saját kulacsaikat töltsék meg
                különböző italokkal, legyen az kóla, szóda vagy más üdítő.
              </p>
              <p className="text-lg text-slate-700 mb-6">
                Az automata intelligens érzékelőkkel van felszerelve, amelyek
                felismerik a kulacs méretét és ennek megfelelően adagolják az
                italt. A felhasználóbarát érintőképernyős felület egyszerű és
                intuitív használatot biztosít.
              </p>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-700">
              A SQUO projekt elsődleges célja a műanyaghulladék csökkentése és
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="gradient-border card">
              ...
              <h3 className="text-xl font-semibold mb-4">
                Palackmentes Megoldás
              </h3>
              <p className="text-slate-600">
                A SQUO teljesen kiküszöböli az egyszer használatos műanyag
                palackokat, lehetővé téve a felhasználók számára, hogy saját
                kulacsaikat használják.
              </p>
            </div>
            ...
            <div className="gradient-border card">
              ...
              <p className="text-slate-600">
                Az italok mikroműanyag-mentesek, ami jelentősen csökkenti a
                környezeti terhelést és az egészségügyi kockázatokat.
              </p>
            </div>
            ...
            <div className="gradient-border card">
              ...
              <h3 className="text-xl font-semibold mb-4">
                Újrahasznosított Kulacsok
              </h3>
              <p className="text-slate-600">
                A SQUO újrahasznosított anyagokból készült kulacsokat is kínál,
                amelyek teljesen mikroműanyag-mentesek és környezetbarátok.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 gradient-border bg-white rounded-xl shadow-md p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <p className="text-slate-600">
                  Megspórolt műanyag palack naponta
                </p>
              </div>
              <div>
                ...
                <p className="text-slate-600">
                  Kevesebb műanyaghulladék évente
                </p>
              </div>
              <div>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg mb-8">
              Csatlakozzon hozzánk a fenntarthatóbb jövőért! Vegye fel velünk a
              kapcsolatot, hogy többet tudjon meg a SQUO automatáról.
            </p>
